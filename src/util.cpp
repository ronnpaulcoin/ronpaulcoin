...
const char * const BITCOIN_CONF_FILENAME = "ronpaulcoin.conf";
const char * const BITCOIN_PID_FILENAME = "ronpaulcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ronpaulcoin";
#else
    // Unix
