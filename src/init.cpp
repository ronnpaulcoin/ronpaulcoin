...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ronpaulcoin-project/ronpaulcoin>";
    const std::string URL_WEBSITE = "<https://ronpaulcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Ronpaulcoin version %s\n", FormatFullVersion());
}
