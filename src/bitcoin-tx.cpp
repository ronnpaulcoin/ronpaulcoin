...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ronpaulcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ronpaulcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ronpaulcoin transaction") + "\n" +
              "  ronpaulcoin-tx [options] -create [commands]   " + _("Create hex-encoded ronpaulcoin transaction") + "\n" +
              "\n";
